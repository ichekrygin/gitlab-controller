...
GitLabController has set of expectation for the crossplane environment. These expectations must be satisfied before creating _GitLabAapplication_ instance
